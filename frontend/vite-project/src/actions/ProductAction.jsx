...
export const getproductDetails = (id) => async (dispatch) =>{
    try {
        ...
        const {data} = await axios.get(`http://localhost:3000/api/auth/product/${id}`);
...
export const getAdminProducts = () => async (dispatch) =>{
    try {
        ...
        const {data} = await axios.get(`http://localhost:3000/api/auth/admin/products`,config);
...
export const createProduct = (productData) => async (dispatch) =>{
    try {
        ...
        const {data} = await axios.post(`http://localhost:3000/api/auth/admin/product/new`,productData,config);
...
export const updateProduct = (id,productData) => async (dispatch) =>{
    try {
        ...
        const {data} = await axios.put(`http://localhost:3000/api/auth/admin/product/${id}`,productData,config);
...
export const deleteProduct = (id) => async (dispatch) =>{
    try {
        ...
        const {data} = await axios.delete(`http://localhost:3000/api/auth/admin/product/${id}`,config);
...
export const newReview = (reviewData) => async (dispatch) =>{
    try {
        ...
        const {data} = await axios.put(`http://localhost:3000/api/auth/review`,reviewData,config);
