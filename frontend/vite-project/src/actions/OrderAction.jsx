...
export const myOrders = () => async(dispatch) =>{
    try {
        ...
        const {data} = await axios.get('http://localhost:3000/api/auth/orders/me', config);
        dispatch({
...
export const getallOrders = () => async(dispatch) =>{
    try {
        ...
        const {data} = await axios.get('http://localhost:3000/api/auth/admin/orders', config);
        dispatch({
...
export const updateOrders = (id,order) => async(dispatch) =>{
    try {
        ...
        const {data} = await axios.put(`http://localhost:3000/api/auth/admin/order/${id}` ,order,config);
        dispatch({
...
export const deleteOrders = (id) => async(dispatch) =>{
    try {
        ...
        const {data} = await axios.delete(`http://localhost:3000/api/auth/admin/order/${id}` ,config);
        dispatch({
...
export const getOrderDetails = (id) => async(dispatch) =>{
    try {
        ...
        const {data} = await axios.get(`http://localhost:3000/api/auth/order/${id}`, config);
        dispatch({
